...
// You draw whatever, and when you click calculate, the parts that can be interpreted as a function are highlighted and 
// derivative is found

const canvas = document.getElementById('canvas');  // for interactions with the element
const drawCanvas = document.getElementById('draw-canvas');

const ctx = canvas.getContext('2d');  // for drawing stuff
